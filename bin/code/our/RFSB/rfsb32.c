...
#define EVENSTEP(A)                         \
	...
	FOLDM(%xmm3, %xmm7, %xmm0);         \
	FOLDX(%xmm0, %xmm4, %xmm5, %xmm3);  \
	FOLDX(%xmm1, %xmm5, %xmm6, %xmm3);  \
	FOLDX(%xmm2, %xmm6, %xmm7, %xmm3);
#define ODD_STEP(A)                         \
	asm                                 \
	(                                   \
		  "movaps   (%0), %%xmm0\n" \
	...
	FOLDM(%xmm7, %xmm3, %xmm4);         \
	FOLDX(%xmm4, %xmm0, %xmm1, %xmm7);  \
	FOLDX(%xmm5, %xmm1, %xmm2, %xmm7);  \
	FOLDX(%xmm6, %xmm2, %xmm3, %xmm7);
	
inline void update(byte state[W])
{
	byte tmp[16] __attribute__((aligned(16)));
