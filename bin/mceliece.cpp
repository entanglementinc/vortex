...
int cipher(int k, unsigned int n, unsigned int z, unsigned char ** publicKeyG, unsigned int r, unsigned int m, unsigned char **SInverse, unsigned char **PInverse, unsigned char **G, unsigned char **S, unsigned int publicKeyt)
{
...
int main()
{
 ...
 cipher(k, n, z, publicKeyG, r, m, SInverse, PInverse ,G, S, publicKeyt);
